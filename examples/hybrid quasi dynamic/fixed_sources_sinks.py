"""
This example sets up a hybrid dynamic_quasistatic two-phase flow simulation in a pore network using the approximate multiscale solver.
...
from pypnm.multiscale.multiscale_unstructured_hybrid1 import MultiScaleSimUnstructured
